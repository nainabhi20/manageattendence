...
public class saturday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor cursor=db.rawQuery("SELECT * FROM TIME_TABLE WHERE DAY_NAME='SATURDAY'",null);
        ...
        Button add_subject=(Button)root.findViewById(R.id.add_subject_saturday_time_table);
        ...
        //-->>
        GridView gridView=(GridView)root.findViewById(R.id.grid_view_saturday);
