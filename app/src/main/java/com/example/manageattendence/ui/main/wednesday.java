...
public class wednesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor cursor=db.rawQuery("SELECT * FROM TIME_TABLE WHERE DAY_NAME='WEDNESDAY'",null);
        ...
        Button add_subject=(Button)root.findViewById(R.id.add_subject_wednesday_time_table);
        ...
        //-->>
        GridView gridView=(GridView)root.findViewById(R.id.grid_view_wednesday);
